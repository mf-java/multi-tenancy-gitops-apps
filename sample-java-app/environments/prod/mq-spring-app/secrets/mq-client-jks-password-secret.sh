...
# Set variables
KEY_STORE_PASSWORD=${KEY_STORE_PASSWORD:-sample-java-appclientprod}
...
kubeseal -n prod --controller-name=${SEALED_SECRET_CONTOLLER_NAME} --controller-namespace=${SEALED_SECRET_NAMESPACE} -o yaml < delete-sample-java-app-client-jks-password-secret.yaml > sample-java-app-client-jks-password-secret.yaml
