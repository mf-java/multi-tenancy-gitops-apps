...
# Set variables
KEY_STORE_PASSWORD=${KEY_STORE_PASSWORD:-sample-java-appclientdev}
...
kubeseal -n dev --controller-name=${SEALED_SECRET_CONTOLLER_NAME} --controller-namespace=${SEALED_SECRET_NAMESPACE} -o yaml < delete-sample-java-app-client-jks-password-secret.yaml > sample-java-app-client-jks-password-secret.yaml
